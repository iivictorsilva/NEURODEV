...
// Consultar tarefas e incluir o nome do professor
$sql = "SELECT tarefas.id, tarefas.titulo, tarefas.descricao, tarefas.prazo, usuarios.nome AS nome_professor
        FROM tarefas
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>Descrição</th>
                            <th>Prazo</th>
                            <th>Professor Responsável</th> <!-- Coluna para nome do professor -->
                            <th>Ações</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>" . $row['nome_professor'] . "</td>";  // Exibindo o nome do professor
                                echo "<td>
                                        <a href='editar_tarefa.php?id=" . $row['id'] . "' class='btn btn-warning btn-sm'>Editar</a>
                                        <a href='deletar_tarefa.php?id=" . $row['id'] . "' class='btn btn-danger btn-sm'>Deletar</a>
                                      </td>";
                                echo "</tr>";
                            }
                        } else {
