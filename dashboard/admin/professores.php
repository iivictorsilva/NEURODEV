                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td>" . $row['cpf'] . "</td>";
                                echo "<td>
                                <a href='editar_professor.php?id=" . $row['id'] . "' class='btn btn-warning btn-sm'>Editar</a>
                                <a href='deletar_usuario.php?id=" . $row['id'] . "&tipo=professor' class='btn btn-danger btn-sm'>Deletar</a>
                              </td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "<tr><td colspan='5' class='text-center'>Nenhum professor encontrado</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
